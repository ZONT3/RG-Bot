    ...
    public static class Msg {
        public static MessageEmbed status(ServerInfoStruct serverInfo, String gmRoleID) {
            ...
            EmbedBuilder builder = new EmbedBuilder()
                    ...
                    .addField(STR.getString("status.main.online"), Tools.countPlayers(online), true)
                    .addField(
        ...
        public static MessageEmbed serverStatistic(int playersRecord, int playersTotal) {
            ...
            return new EmbedBuilder()
                    ...
                    .setTitle(STR.getString("status.statistics.title"))
                    .addField(STR.getString("status.statistics.record"), Tools.countPlayers(playersRecord), false)
                    .addField(STR.getString("status.statistics.total"), Tools.countPlayers(playersTotal), false)
                    .build();
        }
    }
}
